...
$reportsurl = new url('/mod/collaborate/reports.php', ['cid' => $cid]);
...
if ($data = $form->get_data()) {
    ...
    $event = \mod_collaborate\event\submission_graded::create(['context' => $PAGE->context, 'objectid' => $PAGE->cm->instance]);
